...
type Service interface {
	...
	FindByID(ctx context.Context, id string) (*entity.BankDto, error)
...
func (s *service) Create(ctx context.Context, dto *entity.BankDto) (*entity.BankDto, error) {
	dto.OrganizationID = shared.GetOrganization(ctx).ID
	return s.repo.Create(ctx, dto)
}

func (s *service) FindByID(ctx context.Context, id string) (*entity.BankDto, error) {
	return s.repo.Get(ctx, id)
}

func (s *service) Update(ctx context.Context, dto *entity.BankDto) (*entity.BankDto, error) {
	dto.OrganizationID = shared.GetOrganization(ctx).ID
